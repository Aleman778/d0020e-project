...
public class DetectionPublisherResource extends ArrowheadResource{

    public DetectionPublisherResource(ArrowheadHttpServer server) throws ArrowheadException {
        super(server);
    }
