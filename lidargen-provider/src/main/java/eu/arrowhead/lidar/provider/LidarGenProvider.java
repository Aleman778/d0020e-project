...
import eu.arrowhead.client.common.model.*;
...
public class LidarGenProvider extends ArrowheadClientMain {
    ...
    public static void main(String[] args) {
        new LidarGenProvider(args);
    }

    private LidarGenProvider(String[] args) {
        Set<Class<?>> classes = new HashSet<>(Arrays.asList(LidarGenResource.class, RequestVerificationFilter.class));
    ...
    private void loadAndCompilePayloads(boolean fromFile) {
        if (fromFile) {
            ...
            if (!serviceUri.equals(LidarGenResource.SERVICE_URI)) {
